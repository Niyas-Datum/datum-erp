...
@Component({
  selector: 'app-purchase-quotation-component',
  standalone: true,
...
export class PurchaseQuotationComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Purchase Quotation';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Purchase Quotation`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Purchase Quotation data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for PurchaseQuotationComponent');
  }
