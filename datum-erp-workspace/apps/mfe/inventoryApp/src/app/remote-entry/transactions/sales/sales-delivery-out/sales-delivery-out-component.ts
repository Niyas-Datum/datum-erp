...
@Component({
  selector: 'app-sales-delivery-out-component',
  standalone: true,
  templateUrl: './sales-delivery-out-component.html',
  styleUrl: './sales-delivery-out-component.css',
...
export class SalesDeliveryOutComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Sales Delivery Out';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Sales Delivery Out`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Sales Delivery Out data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for SalesDeliveryOutComponent');
  }
