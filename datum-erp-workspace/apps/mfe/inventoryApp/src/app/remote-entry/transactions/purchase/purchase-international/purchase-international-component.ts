...
@Component({
  selector: 'app-purchase-international-component',
  standalone: true,
  templateUrl: './purchase-international-component.html',
  styleUrl: './purchase-international-component.css',
...
export class PurchaseInternationalComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Purchase International';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Purchase International`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Purchase International data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for PurchaseInternationalComponent');
  }
