...
@Component({
  selector: 'app-purchase-delivery-in-component',
  standalone: true,
  templateUrl: './purchase-delivery-in-component.html',
  styleUrl: './purchase-delivery-in-component.css',
...
export class PurchaseDeliveryInComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Purchase Delivery In';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Purchase Delivery In`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Purchase Delivery In data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for PurchaseDeliveryInComponent');
  }
