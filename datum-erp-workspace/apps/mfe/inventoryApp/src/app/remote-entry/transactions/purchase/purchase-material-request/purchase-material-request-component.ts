...
@Component({
  selector: 'app-purchase-material-request-component',
  standalone: true,
  templateUrl: './purchase-material-request-component.html',
  styleUrl: './purchase-material-request-component.css',
...
export class PurchaseMaterialRequestComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Purchase Material Request';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Purchase Material Request`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Purchase Material Request data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for PurchaseMaterialRequestComponent');
  }
