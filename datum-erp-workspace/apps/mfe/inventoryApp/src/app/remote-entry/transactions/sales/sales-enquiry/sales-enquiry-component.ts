...
@Component({
  selector: 'app-sales-enquiry-component',
  standalone: true,
  templateUrl: './sales-enquiry-component.html',
  styleUrl: './sales-enquiry-component.css',
...
export class SalesEnquiryComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Sales Enquiry';
    ...
    try {
      ...
      console.error('Error fetching Sales Enquiry data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for SalesEnquiryComponent');
  }
