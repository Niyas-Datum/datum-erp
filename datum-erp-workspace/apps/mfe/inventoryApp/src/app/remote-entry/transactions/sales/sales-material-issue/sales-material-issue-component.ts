...
@Component({
  selector: 'app-sales-material-issue-component',
  standalone: true,
  templateUrl: './sales-material-issue-component.html',
  styleUrl: './sales-material-issue-component.css',
...
export class SalesMaterialIssueComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Sales Material Issue';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Sales Material Issue`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Sales Material Issue data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for SalesMaterialIssueComponent');
  }
