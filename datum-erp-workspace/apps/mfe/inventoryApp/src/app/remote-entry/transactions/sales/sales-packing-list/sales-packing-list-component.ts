...
@Component({
  selector: 'app-sales-packing-list-component',
  standalone: true,
  templateUrl: './sales-packing-list-component.html',
  styleUrl: './sales-packing-list-component.css',
...
export class SalesPackingListComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Sales Packing List';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Sales Packing List`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Sales Packing List data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for SalesPackingListComponent');
  }
