...
export class PurchaseOrderComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for PurchaseOrderComponent');
  }
