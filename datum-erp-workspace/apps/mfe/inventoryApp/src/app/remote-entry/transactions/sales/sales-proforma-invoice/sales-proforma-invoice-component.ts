...
@Component({
  selector: 'app-sales-proforma-invoice-component',
  standalone: true,
  templateUrl: './sales-proforma-invoice-component.html',
  styleUrl: './sales-proforma-invoice-component.css',
...
export class SalesProformaInvoiceComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  override async LeftGridInit(): Promise<void> {
    this.pageheading = 'Sales Proforma Invoice';
    ...
    try {
      ...
      this.leftGrid.leftGridColumns = [
        {
          headerText: 'Sales Proforma Invoice`s',
          columns: [
            {
              field: 'TransactionNo',
      ...
      console.error('Error fetching Sales Proforma Invoice data:', error);
  ...
  protected override FormInitialize(): void {
    ...
    console.log('FormInitialize completed for SalesProformaInvoiceComponent');
  }
